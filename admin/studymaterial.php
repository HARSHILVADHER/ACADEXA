...
<head>
    ...
    <title>Study Material - Acadexa</title>
...
<body>
    ...
    <div class="container">
        ...
        <p class="subtext">Upload and manage study materials for your classes</p>
        ...
        <div class="upload-section">
            ...
            <form id="uploadForm" action="php/studymaterial.php" method="POST" enctype="multipart/form-data">
                <div class="form-grid">
                    <div class="form-group">
                        <label for="materialTitle">Material Title</label>
                        <input type="text" id="materialTitle" name="title" required placeholder="Enter material title">
                    </div>
                    
                    <div class="form-group">
                        <label for="classSelect">Select Class</label>
                        <select id="classSelect" name="class_code" required>
                    ...
                    <div class="form-group full-width">
                        ...
                        <div class="file-upload">
                            <input type="file" id="fileInput" name="material_file" accept=".pdf,.doc,.docx,.ppt,.pptx,.txt,.jpg,.jpeg,.png" required>
                            <div class="file-upload-content">
                                <i class="fas fa-file-upload"></i>
                                <div class="file-upload-text">Click to upload or drag and drop</div>
                                <div class="file-upload-subtext">PDF, DOC, PPT, Images (Max 10MB)</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
            ...
            fetch('php/get_materials.php')
                ...
                .then(materials => {
                    ...
                    if (!Array.isArray(materials) || materials.length === 0) {
                        grid.innerHTML = '<p style="text-align: center; color: var(--gray); grid-column: 1 / -1;">No materials uploaded yet.</p>';
                        return;
                    }
            ...
            card.innerHTML = `
                <div class="material-header">
                    ...
                    <div>
                        ...
                        <div class="material-class">${material.class_name} - ${material.subject}</div>
                    </div>
                </div>
                <div style="color: var(--gray); font-size: 0.9rem; margin-bottom: 10px;">
                    Type: ${material.type} | Uploaded: ${new Date(material.created_at).toLocaleDateString()}
                </div>
                ${material.description ? `<div style="color: var(--gray); font-size: 0.9rem; margin-bottom: 15px;">${material.description}</div>` : ''}
                <div class="material-actions">
                    <button class="btn btn-sm btn-outline" onclick="downloadMaterial(${material.id})">
        ...
        function downloadMaterial(id) {
            window.open(`php/download_material.php?id=${id}`, '_blank');
        }
        ...
        fileUpload.addEventListener('dragleave', () => {
            fileUpload.style.background = 'rgba(67, 97, 238, 0.02)';
        });
