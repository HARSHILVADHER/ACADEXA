...
if (empty($className) || empty($subjectName) || empty($subjectCode) || !$facultyId || empty($dayOfWeek) || empty($startTime) || empty($endTime)) {
...
try {
    ...
    $stmt->bind_param('sssssssssi', $classCode, $className, $subjectName, $subjectCode, $facultyId, $facultyData['name'], $dayOfWeek, $startTime, $endTime, $userId);
